export const questions = [
	...
	{
		content:
			'Вместо определения grid-элемента на основе начальной и конечной позиции grid-строк вы можете задавать их с помощью необходимой вам ширины строк, используя span. Помните, что span работает только с положительными значениями. Для примера, полейте эту тыквуw, используя свойство grid-column-end: span 2.',
		option: '',
